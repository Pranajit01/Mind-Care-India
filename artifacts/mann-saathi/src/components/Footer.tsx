...
export function Footer() {
  return (
    <footer className="bg-[#050505] border-t border-white/5 pt-16 pb-12 px-4 sm:px-6 lg:px-8 mt-24">
      <div className="max-w-7xl mx-auto">
        
        {/* Emergency Disclaimer Banner */}
        <div className="glass-card bg-[#FF4500]/5 border border-[#FF4500]/30 rounded-2xl p-6 mb-12 flex items-start gap-4">
          <AlertTriangle className="w-6 h-6 text-[#FF4500] shrink-0 mt-0.5" />
          <div className="flex-1">
            <h3 className="font-playfair text-xl text-white mb-1 tracking-tight">Important Safety Disclaimer</h3>
            ...
            <div className="flex flex-wrap gap-4 text-xs font-mono">
              <a href="tel:14416" className="text-[#FF4500] hover:underline flex items-center gap-1.5 font-semibold">
                <Phone className="w-3.5 h-3.5" /> Tele-MANAS: 14416 / 1800-891
              </a>
              <a href="tel:9152987821" className="text-[#0052cc] hover:underline flex items-center gap-1.5 font-semibold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4 md:col-span-1">
            <Link href="/" className="font-playfair text-3xl text-white block tracking-tighter">
              Mann Saathi
            </Link>
          ...
          <div>
            <h5 className="text-[10px] font-mono tracking-[0.4em] uppercase text-neutral-500 mb-4">PLATFORM NAV</h5>
          ...
          <div>
            <h5 className="text-[10px] font-mono tracking-[0.4em] uppercase text-neutral-500 mb-4">CRISIS HELPLINES</h5>
            <ul className="space-y-2.5 text-xs text-neutral-400 font-sans">
              <li className="text-[#FF4500] font-medium">Tele-MANAS: 14416 / 1800-891</li>
              <li className="text-[#0052cc] font-medium">Vandrevala Foundation: +91 9999 666 555</li>
          ...
          <div>
            <h5 className="text-[10px] font-mono tracking-[0.4em] uppercase text-neutral-500 mb-4">SYSTEM STATUS</h5>
            <div className="glass-card p-4 rounded-xl space-y-3">
              <div className="flex items-center gap-2">
                <span className="w-2.5 h-2.5 rounded-full bg-[#22c55e] animate-pulse" />
                <span className="text-xs font-mono font-semibold text-white uppercase tracking-wider">System Operational</span>
              </div>
